...
public class CompanyProductServiceImpl implements CompanyProductService {
    ...
    @Override
    public List<CompanyProduct> getCompanyProductsByIds(Integer companyId, Integer productId)
    {
        return companyProductDao.selectCompanyProductsByIds(companyId,productId);
    }

    @Override
    public void consumeCompanyProductByIds(Integer companyId, Integer productId){
        companyProductDao.consumeCompanyProductsByIds(companyId,productId);
    }
